...
void test2()
{
	struct s_list_cmd cat = {
		.cmds_args = (char *[]){ "cat", "Makefile" , NULL },
	};

	struct s_list_cmd wc = {
		.cmds_args = (char *[]){ "wc", "-l" , NULL },
	};
...
// {
// 	struct s_list_cmd cat = {
// 		.cmds_args = (char *[]){ "/bin/cat", "Makefile" , NULL },
// 	};

// 	struct s_list_cmd wc = {
// 		.cmds_args = (char *[]){ "/usr/bin/wc", "-l" , NULL },
// 		.input = INPUT_FILE,
// 		.infile = "main.c",
// 	};
...
// 		.cmds_args = (char *[]){ "./cat1", NULL },
// 	};


// 	struct s_list_cmd cat2 = {
// 		.cmds_args = (char *[]){ "./cat2", NULL },
// 	};
...
// {
// 	struct s_list_cmd wc = {
// 		.cmds_args = (char *[]){ "/usr/bin/wc", NULL },
// 		.input = INPUT_HEREDOC,
// 		.heredoc = "hello world!\n",
// 	};
